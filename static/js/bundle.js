...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configure = __webpack_require__(249);

	var _configure2 = _interopRequireDefault(_configure);

	var _groups = __webpack_require__(273);
	...
	var _userDetail = __webpack_require__(277);

	var _userDetail2 = _interopRequireDefault(_userDetail);

	var _groupDetail = __webpack_require__(278);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(_reactRouter.Route, { path: 'groups/:groupId', component: _groupDetail2.default }),
	            _react2.default.createElement(_reactRouter.Route, { path: 'users/:userId', component: _userDetail2.default })
	        )
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureStore() {
	    var store = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default), (0, _redux.applyMiddleware)((0, _reduxLogger2.default)()))(_redux.createStore)(_reducers.rootReducer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _group = __webpack_require__(272);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RESET_REMOVE_USER = exports.REMOVE_USER_FAILURE = exports.REMOVE_USER_SUCCESS = exports.REMOVE_USER = exports.RESET_SAVE_USER = exports.SAVE_USER_FAILURE = exports.SAVE_USER_SUCCESS = exports.SAVE_USER = exports.RESET_GET_USER = exports.GET_USER_FAILURE = exports.GET_USER_SUCCESS = exports.GET_USER = exports.RESET_GET_USERS = exports.GET_USERS_FAILURE = exports.GET_USERS_SUCCESS = exports.GET_USERS = undefined;
	exports.getUsers = getUsers;
	exports.getUsersSuccess = getUsersSuccess;
	exports.getUsersFailure = getUsersFailure;
	exports.resetGetUsers = resetGetUsers;
	exports.getUser = getUser;
	exports.getUserSuccess = getUserSuccess;
	exports.getUserFailure = getUserFailure;
	exports.resetGetUser = resetGetUser;
	exports.saveUser = saveUser;
	exports.saveUserSuccess = saveUserSuccess;
	exports.saveUserFailure = saveUserFailure;
	exports.resetSaveUser = resetSaveUser;
	exports.removeUser = removeUser;
	exports.removeUserSuccess = removeUserSuccess;
	exports.removeUserFailure = removeUserFailure;
	exports.resetRemoveUser = resetRemoveUser;
	...
	var RESET_GET_USERS = exports.RESET_GET_USERS = 'RESET_GET_USERS';
	...
	var RESET_GET_USER = exports.RESET_GET_USER = 'RESET_GET_USER';
	...
	var RESET_SAVE_USER = exports.RESET_SAVE_USER = 'RESET_SAVE_USER';
	var REMOVE_USER = exports.REMOVE_USER = 'REMOVE_USER';
	var REMOVE_USER_SUCCESS = exports.REMOVE_USER_SUCCESS = 'REMOVE_USER_SUCCESS';
	var REMOVE_USER_FAILURE = exports.REMOVE_USER_FAILURE = 'REMOVE_USER_FAILURE';
	var RESET_REMOVE_USER = exports.RESET_REMOVE_USER = 'RESET_REMOVE_USER';

	var ROOT_URL = location.href.indexOf('localhost') > 0 ? 'http://localhost:8000/api' : '/api';
	...
	function getUser(id) {
	    var request = _axios2.default.get(ROOT_URL + '/users/' + id);
	...
	function saveUser(id) {
	    var request = _axios2.default.put(ROOT_URL + '/users/' + id);
	...
	function removeUser(id) {
	    var request = _axios2.default.delete(ROOT_URL + '/users/' + id);
	...
	function removeUserFailure(error) {
	    return {
	...
	var Groups = function (_React$Component) {
	    ...
	    _createClass(Groups, [{
	        ...
	        value: function edit(event) {
	            event.preventDefault();
	            var id = event.target.elements[0].value.toLowerCase();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _users = __webpack_require__(275);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        getUsers: function getUsers(id) {
	            // obj.payload: Promise
	            dispatch((0, _user.getUsers)(id)).payload.then(function (response) {
	                !response.error ? dispatch((0, _user.getUsersSuccess)(response)) : dispatch((0, _user.getUsersFailure)(response));
	            });
	        }
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Users = function (_React$Component) {
	    ...
	    _createClass(Users, [{
	        ...
	        key: 'render',
	        value: function render() {
	            var _props$userList = this.props.userList;
	            var users = _props$userList.users;
	            var loading = _props$userList.loading;
	            var error = _props$userList.error;
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'p',
	                    null,
	                    'Test app with python server side and react'
	                )
	            );
	        }
	    }]);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement("input", { type: "text", "class": "form-control", id: "first" })
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { "class": "form-group" },
	                        ...
	                        _react2.default.createElement("input", { type: "text", "class": "form-control", id: "last" })
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { "class": "form-group" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GroupDetail = function (_React$Component) {
	    ...
	    function GroupDetail() {
	        ...
	        return _possibleConstructorReturn(this, (GroupDetail.__proto__ || Object.getPrototypeOf(GroupDetail)).apply(this, arguments));
	    }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement("input", { type: "text", "class": "form-control", id: "title" })
	                    ),
	                    _react2.default.createElement(
	                        "button",
	                        { type: "submit", "class": "btn btn-default" },
